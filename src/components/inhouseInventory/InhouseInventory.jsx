  ...
  return (
    <>
      ...
      <div className="flex justify-center my-4">
        <h1 className="text-2xl font-bold">Inhouse Inventory List</h1>
      </div>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          <Button onClick={() => setOpenModal(true)}>Add InhouseInventory</Button>
          <Button color="warning" onClick={fetchLowStock}>
            Low Stock
          </Button>
          <Button color="purple" onClick={fetchExpiringSoon}>
            Expiring Soon
          </Button>
